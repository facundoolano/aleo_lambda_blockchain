...
mod tests {
    ...
    fn rewards_are_deterministic() {
        ...
        records11.sort_by_key(|(commitment, _value)| *commitment);
        records21.sort_by_key(|(commitment, _value)| *commitment);
        ...
        records12.sort_by_key(|(commitment, _value)| *commitment);
        records22.sort_by_key(|(commitment, _value)| *commitment);
